...
src = glob.glob('C:/Dev/compare_reports_KUPOL_1C/compare_reports_KUPOL_1C/save/isrs_report/*.xlsx') # * means all if need specific format then *.csv
...
def get_filename():
    list_of_files = glob.glob('C:/Dev/compare_reports_KUPOL_1C/compare_reports_KUPOL_1C/save/isrs_report/*.xlsx') # * means all if need specific format then *.csv
...
def main():
    ...
    for name, email in zip(names, emails):
        ...
        msg['From']=MY_ADDRESS
        msg['To']=email
        msg['Subject']="Сверка перемещений между КУПОЛ и 1С"
